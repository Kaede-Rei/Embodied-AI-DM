...
"""autogenerated by genpy from dm_arm_msgs_srvs/dm_arm_cmdRequest.msg. Do not edit."""
import codecs
import sys
...
class dm_arm_cmdRequest(genpy.Message):
  _md5sum = "e14b35af0de9d5af1d4dbee6b2e8766b"
  _type = "dm_arm_msgs_srvs/dm_arm_cmdRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(dm_arm_cmdRequest, self).__init__(*args, **kwds)
...
def _get_struct_6d():
    ...
    return _struct_6d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from dm_arm_msgs_srvs/dm_arm_cmdResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class dm_arm_cmdResponse(genpy.Message):
  _md5sum = "7e1b53476df714dd5d04f5cf9fe8e844"
  _type = "dm_arm_msgs_srvs/dm_arm_cmdResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# 响应部分
bool success        # 执行是否成功
string message      # 返回消息
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(dm_arm_cmdResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_B():
    ...
    return _struct_B
class dm_arm_cmd(object):
  _type          = 'dm_arm_msgs_srvs/dm_arm_cmd'
  _md5sum = 'ab876838156246ec2905cd94b5756b0a'
  _request_class  = dm_arm_cmdRequest
  _response_class = dm_arm_cmdResponse
