...
if("TRUE" STREQUAL "TRUE")
  set(pr2_description_SOURCE_PREFIX /home/kaerei/ROS_Workspace/roslearn/multi_arm_ws/src/pr2_description)
  set(pr2_description_DEVEL_PREFIX /home/kaerei/ROS_Workspace/roslearn/multi_arm_ws/devel)
  ...
  set(pr2_description_INSTALL_PREFIX /home/kaerei/ROS_Workspace/roslearn/multi_arm_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pr2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kaerei/ROS_Workspace/roslearn/multi_arm_ws/src/pr2_description/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(pr2_description_EXPORTED_TARGETS ${${pr2_description_dep}_EXPORTED_TARGETS})
endforeach()
